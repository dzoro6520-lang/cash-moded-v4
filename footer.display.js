...
(function () {
  ...
  if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", updateNavBalanceDisplay);
  else updateNavBalanceDisplay();
  window.addEventListener("pageshow", updateNavBalanceDisplay);
